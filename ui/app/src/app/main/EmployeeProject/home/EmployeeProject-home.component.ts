...
@Component({
  selector: 'EmployeeProject-home',
  templateUrl: './EmployeeProject-home.component.html',
  styleUrls: ['./EmployeeProject-home.component.scss']
})
export class EmployeeProjectHomeComponent implements AfterViewInit {
